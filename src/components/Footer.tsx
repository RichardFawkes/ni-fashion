        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Prazos e Entregas</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Trocas e Devoluções</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Pagamentos e Reembolso</a></li>
            </ul>
          </div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="mt-6">
                <button
                  ...
                  className="flex items-center text-white bg-black hover:bg-gray-800 transition-colors px-4 py-2 rounded-sm"
                >
                  <svg
