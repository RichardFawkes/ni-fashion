...
export default function EditProduct({ params }: EditProductProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const success = await productService.updateProduct(updatedProduct);
      
      if (success) {
        alert('Produto atualizado com sucesso no localStorage e em arquivo JSON!');
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-6">O produto que você está tentando editar não existe.</p>
          <Link 
            href="/admin/products" 
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="image" className="block text-sm font-medium text-gray-700">Imagem do Produto (opcional)</label>
                  <input
                    type="file"
                    id="image"
                    accept="image/*"
                ...
                {imagePreview && (
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 mb-2">Imagem atual/preview:</p>
