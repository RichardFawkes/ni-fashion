...
export default function NewProductClient() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Upload da imagem - agora salva fisicamente no servidor
      if (imageFile) {
        // Passa a categoria para o upload para melhor organização dos arquivos
        const storedImage = await imageService.saveImage(imageFile, formData.category);
        
        // Usar o caminho do servidor se disponível, caso contrário usar base64
      ...
      alert('Produto salvo com sucesso no arquivo JSON e a imagem foi salva no servidor!');
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    A imagem será salva fisicamente no servidor seguindo o padrão descrito no README.
                  </p>
                </div>
